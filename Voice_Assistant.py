...
def sendEmail(to, content):
    ...
    server.starttls()
    # Enter your email
    server.login('subhamsahu000001@gmail.com', 'codesownway0707')
    server.sendmail('subhamsahu000001@gmail.com', to, content)
    server.close()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # elif 'wikipedia random' in query:
            # webbrowser.open("https://wikiroulette.co/")
